...
美債收益率曲線趨平釋放信號，市場對美聯儲遏制通脹的努力會破壞美國的復甦愈發擔心。美國消費者價格再度超出預期之際，30 年期和 5 年期美債收益率之差本週跌向 17 個月低點。目前該收益率差在 100 個基點左右，自 6 月份美聯儲官員暗示在 2023 年底前將加息兩次以來，美債收益率曲線的趨平態勢就開始加速。Asset Management One Co.基金經理 Akira Takei 稱，這反映出市場對增長放緩及高通脹並存的預期。供應瓶頸驅動的高通脹將減少需求並損害經濟。
